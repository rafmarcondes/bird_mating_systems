...
for (sp in rownames(priormatrix1)) {
  # cat(sp, '\n')
  if (priormatrix1[sp, "Lit_mating"] == "U") {
    priormatrix1[sp, 3:5] <- ps1[11, 3:5]
  }
  if (priormatrix1[sp, "Lit_mating"] == "PU") {
    priormatrix1[sp, 3:5] <- ps1[10, 3:5]
  }

  if (priormatrix1[sp, "Lit_mating"] == "M" & priormatrix1[sp, "Data_quality"] == 3) {
    priormatrix1[sp, 3:5] <- ps1[1, 3:5]
  }
  if (priormatrix1[sp, "Lit_mating"] == "P" & priormatrix1[sp, "Data_quality"] == 3) {
    priormatrix1[sp, 3:5] <- ps1[2, 3:5]
  }
  if (priormatrix1[sp, "Lit_mating"] == "L" & priormatrix1[sp, "Data_quality"] == 3) {
    priormatrix1[sp, 3:5] <- ps1[3, 3:5]
  }

  if (priormatrix1[sp, "Lit_mating"] == "M" & priormatrix1[sp, "Data_quality"] == 2) {
    priormatrix1[sp, 3:5] <- ps1[4, 3:5]
  }
  if (priormatrix1[sp, "Lit_mating"] == "P" & priormatrix1[sp, "Data_quality"] == 2) {
    priormatrix1[sp, 3:5] <- ps1[5, 3:5]
  }
  if (priormatrix1[sp, "Lit_mating"] == "L" & priormatrix1[sp, "Data_quality"] == 2) {
    priormatrix1[sp, 3:5] <- ps1[6, 3:5]
  }

  if (priormatrix1[sp, "Lit_mating"] == "M" & priormatrix1[sp, "Data_quality"] == 1) {
    priormatrix1[sp, 3:5] <- ps1[7, 3:5]
  }
  if (priormatrix1[sp, "Lit_mating"] == "P" & priormatrix1[sp, "Data_quality"] == 1) {
    priormatrix1[sp, 3:5] <- ps1[8, 3:5]
  }
  if (priormatrix1[sp, "Lit_mating"] == "L" & priormatrix1[sp, "Data_quality"] == 1) {
    priormatrix1[sp, 3:5] <- ps1[9, 3:5]
  }
}
...
for (sp in rownames(priormatrix2)) {
  # cat(sp, '\n')
  if (priormatrix2[sp, "Lit_mating"] == "U") {
    priormatrix2[sp, 3:5] <- ps2[11, 3:5]
  }
  if (priormatrix2[sp, "Lit_mating"] == "PU") {
    priormatrix2[sp, 3:5] <- ps2[10, 3:5]
  }

  if (priormatrix2[sp, "Lit_mating"] == "M" & priormatrix2[sp, "Data_quality"] == 3) {
    priormatrix2[sp, 3:5] <- ps2[1, 3:5]
  }
  if (priormatrix2[sp, "Lit_mating"] == "P" & priormatrix2[sp, "Data_quality"] == 3) {
    priormatrix2[sp, 3:5] <- ps2[2, 3:5]
  }
  if (priormatrix2[sp, "Lit_mating"] == "L" & priormatrix2[sp, "Data_quality"] == 3) {
    priormatrix2[sp, 3:5] <- ps2[3, 3:5]
  }

  if (priormatrix2[sp, "Lit_mating"] == "M" & priormatrix2[sp, "Data_quality"] == 2) {
    priormatrix2[sp, 3:5] <- ps2[4, 3:5]
  }
  if (priormatrix2[sp, "Lit_mating"] == "P" & priormatrix2[sp, "Data_quality"] == 2) {
    priormatrix2[sp, 3:5] <- ps2[5, 3:5]
  }
  if (priormatrix2[sp, "Lit_mating"] == "L" & priormatrix2[sp, "Data_quality"] == 2) {
    priormatrix2[sp, 3:5] <- ps2[6, 3:5]
  }

  if (priormatrix2[sp, "Lit_mating"] == "M" & priormatrix2[sp, "Data_quality"] == 1) {
    priormatrix2[sp, 3:5] <- ps2[7, 3:5]
  }
  if (priormatrix2[sp, "Lit_mating"] == "P" & priormatrix2[sp, "Data_quality"] == 1) {
    priormatrix2[sp, 3:5] <- ps2[8, 3:5]
  }
  if (priormatrix2[sp, "Lit_mating"] == "L" & priormatrix2[sp, "Data_quality"] == 1) {
    priormatrix2[sp, 3:5] <- ps2[9, 3:5]
  }
}
...
for (sp in rownames(priormatrix3)) {
  # cat(sp, '\n')
  if (priormatrix3[sp, "Lit_mating"] == "U") {
    priormatrix3[sp, 3:5] <- ps3[11, 3:5]
  }
  if (priormatrix3[sp, "Lit_mating"] == "PU") {
    priormatrix3[sp, 3:5] <- ps3[10, 3:5]
  }

  if (priormatrix3[sp, "Lit_mating"] == "M" & priormatrix3[sp, "Data_quality"] == 3) {
    priormatrix3[sp, 3:5] <- ps3[1, 3:5]
  }
  if (priormatrix3[sp, "Lit_mating"] == "P" & priormatrix3[sp, "Data_quality"] == 3) {
    priormatrix3[sp, 3:5] <- ps3[2, 3:5]
  }
  if (priormatrix3[sp, "Lit_mating"] == "L" & priormatrix3[sp, "Data_quality"] == 3) {
    priormatrix3[sp, 3:5] <- ps3[3, 3:5]
  }

  if (priormatrix3[sp, "Lit_mating"] == "M" & priormatrix3[sp, "Data_quality"] == 2) {
    priormatrix3[sp, 3:5] <- ps3[4, 3:5]
  }
  if (priormatrix3[sp, "Lit_mating"] == "P" & priormatrix3[sp, "Data_quality"] == 2) {
    priormatrix3[sp, 3:5] <- ps3[5, 3:5]
  }
  if (priormatrix3[sp, "Lit_mating"] == "L" & priormatrix3[sp, "Data_quality"] == 2) {
    priormatrix3[sp, 3:5] <- ps3[6, 3:5]
  }

  if (priormatrix3[sp, "Lit_mating"] == "M" & priormatrix3[sp, "Data_quality"] == 1) {
    priormatrix3[sp, 3:5] <- ps3[7, 3:5]
  }
  if (priormatrix3[sp, "Lit_mating"] == "P" & priormatrix3[sp, "Data_quality"] == 1) {
    priormatrix3[sp, 3:5] <- ps3[8, 3:5]
  }
  if (priormatrix3[sp, "Lit_mating"] == "L" & priormatrix3[sp, "Data_quality"] == 1) {
    priormatrix3[sp, 3:5] <- ps3[9, 3:5]
  }
}
